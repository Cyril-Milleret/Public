...
modelCode <- nimbleCode({
  ...
  for(t in 2:n.years){
    for(i in 1:M){
      sxy[i, 1:2, t] ~ dbernppACmovement_normal(lowerCoords = lowerHabCoords[1:numHabWindows, 1:2]
                                                , upperCoords = upperHabCoords[1:numHabWindows, 1:2]
                                                , s = sxy[i, 1:2, t - 1]
                                                , sd = tau
  ...
  for(i in 1:M){ 
    ...
    for(t in 1:n.years1){
      z[i,t+1] ~ dcatState2Dead( zit = z[i,t]
                                 , gamma = gamma[t]
...
setwd("C:/Personal_Cloud/OneDrive/Work/Rovquant/Papers/SpatialSurvivalRates/Simulations/vignette")
